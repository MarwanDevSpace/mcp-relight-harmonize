      ...
      tools: [
        {
          ...
          description:
            "Extract physical optical metrics from an image: Correlated Color Temperature (CCT in Kelvin), " +
        ...
        },
        {
          ...
          description:
            "Generate 4 physically-grounded relit image variations (Ambient fill, Dramatic chiaroscuro, " +
        ...
        },
        {
          ...
          description:
            "Harmonize and composite a foreground element onto a background scene. Applies Reinhard color " +
        ...
        },
        {
          ...
          description:
            "Synthesize precision enhancement and relighting diffusion prompts for GPT Image (DALL-E 3 / GPT-4o) " +
